                    ...
                    if (aerofoil.availableControls != SilantroAerofoil.AvailableControls.SecondaryOnly)
                    {
                        ...
                        if (aerofoil.surfaceType != SilantroAerofoil.SurfaceType.Inactive)
                        {
                            ...
                            if (aerofoil.trimState == SilantroAerofoil.TrimState.Available)
                            {
                                GUILayout.Space(5f);
                                GUI.color = Color.white;
                                EditorGUILayout.HelpBox("Surface Deflection", MessageType.None);
                                GUI.color = backgroundColor;
                                GUILayout.Space(3f);
                                EditorGUILayout.PropertyField(serializedObject.FindProperty("trimAuthorityPositive"), new GUIContent("Positive Authority"));
                                GUILayout.Space(3f);
                                EditorGUILayout.PropertyField(serializedObject.FindProperty("trimAuthorityNegative"), new GUIContent("Negative Authority"));
                                GUILayout.Space(5f);
                                GUI.color = Color.white;
                                ...
                                GUILayout.Space(3f);
                                EditorGUILayout.BeginHorizontal();
                                EditorGUILayout.LabelField(aerofoil.positiveTrimLimit.ToString("0.0") + " ° Down");
                                EditorGUILayout.LabelField(aerofoil.negativeTrimLimit.ToString("0.0") + " ° Up");
                                EditorGUILayout.EndHorizontal();


                                GUILayout.Space(15f);
                                GUI.color = Color.white;
                                EditorGUILayout.HelpBox("Tab Configuration", MessageType.None);
                                GUI.color = backgroundColor;
                                GUILayout.Space(3f);
                                EditorGUILayout.BeginHorizontal();
                                EditorGUILayout.PropertyField(serializedObject.FindProperty("trimTabModel"), new GUIContent(""));
                                EditorGUILayout.PropertyField(serializedObject.FindProperty("trimDeflectionAxis"), new GUIContent(""));
                                EditorGUILayout.PropertyField(serializedObject.FindProperty("trimDeflectionDirection"), new GUIContent(""));
                                EditorGUILayout.EndHorizontal();

                                GUILayout.Space(5f);
                                GUI.color = Color.white;
                                EditorGUILayout.HelpBox("Tab Deflection", MessageType.None);
                                GUI.color = backgroundColor;
                                GUILayout.Space(3f);
                                EditorGUILayout.PropertyField(serializedObject.FindProperty("positiveTabLimit"), new GUIContent("Positive Limit"));
                                GUILayout.Space(3f);
                                EditorGUILayout.PropertyField(serializedObject.FindProperty("negativeTabLimit"), new GUIContent("Negative Limit"));
                                GUILayout.Space(3f);
                                EditorGUILayout.LabelField("Tab Deflection", aerofoil.trimTabDeflection.ToString("0.00") + " °");
                            }
