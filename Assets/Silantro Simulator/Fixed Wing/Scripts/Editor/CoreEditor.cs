...
public class SilantroCoreEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
		...
		GUILayout.Space(3f);
		EditorGUILayout.LabelField("α", core.α.ToString("0.000") + " °");
        GUILayout.Space(3f);
        EditorGUILayout.LabelField("β", core.β.ToString("0.000") + " °");
...
public class SilantroFlightComputerEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		else if(computer.operationMode == SilantroFlightComputer.AugmentationType.Autonomous)
		{
			...
			GUI.color = backgroundColor;
			GUILayout.Space(3f);
			EditorGUILayout.PropertyField(tracker.FindPropertyRelative("taxiTrack"), new GUIContent("Taxi Track"));
			GUILayout.Space(3f);
