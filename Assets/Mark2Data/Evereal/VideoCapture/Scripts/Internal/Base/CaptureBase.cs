...
namespace Evereal.VideoCapture
{
  ...
  public class CaptureBase : MonoBehaviour, ICapture
  {
    ...
    // Camera settings.
    private UnityEngine.Vector3 regularCameraPos = UnityEngine.Vector3.zero;
    ...
    private UnityEngine.Vector3 stereoCameraPos = UnityEngine.Vector3.zero;
    ...
    protected void CreateStereoTextures()
    {
      if (captureSource == CaptureSource.CAMERA && stereoMode != StereoMode.NONE)
      {
                ...
                regularCamera.transform.Translate(new UnityEngine.Vector3(-interpupillaryDistance / 2, 0, 0), Space.Self);
                stereoCamera.transform.Translate(new UnityEngine.Vector3(interpupillaryDistance / 2, 0, 0), Space.Self);
    ...
    protected void RenderCubeFace(CubemapFace face, float x, float y, float w, float h)
    {
            ...
            UnityEngine.Vector3[] faceTexCoords =
      {
        // +x
