...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneAiControl : MonoBehaviour
    {
        ...
        [SerializeField] public bool Activate = true;
        [SerializeField] public bool m_brake = false;
        [SerializeField] public float m_RollSensitivity = .2f;         // How sensitively the AI applies the roll controls
        [SerializeField] public float m_PitchSensitivity = .5f;        // How sensitively the AI applies the pitch controls
        [SerializeField] public float m_LateralWanderDistance = 5;     // The amount that the plane can wander by when heading for a target
        [SerializeField] public float m_LateralWanderSpeed = 0.11f;    // The speed at which the plane will wander laterally
        [SerializeField] public float m_MaxClimbAngle = 45;
        [SerializeField] public float m_MinClimbAngle = 45;  // The maximum angle that the AI will attempt to make plane can climb at
        [SerializeField] public float m_MaxRollAngle = 45;             // The maximum angle that the AI will attempt to u
        [SerializeField] public float m_SpeedEffect = 0.01f;           // This increases the effect of the controls based on the plane's speed.
        [SerializeField] public float m_TakeoffHeight = 20;            // the AI will fly straight and only pitch upwards until reaching this height
        [SerializeField] public Transform m_Target;                    // the target to fly towards
        [SerializeField] public float throttleInput = 0.5f;
        [SerializeField] public float pitch = 0.5f;
        [SerializeField] public float roll = 0.5f;
        [SerializeField] public float yaw = 0.5f;
        ...
        private void FixedUpdate()
        {
            if (m_Target != null)
            {
                ...
                targetAnglePitch = Mathf.Clamp(targetAnglePitch, -m_MinClimbAngle*Mathf.Deg2Rad,
                ...
                if (Activate)
                {
                    ...
                    m_AeroplaneController.Move(rollInput, pitchInput, yawInput, throttleInput, m_brake);
                }
