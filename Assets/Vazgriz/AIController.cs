...
// AI Maneuvers follows the Target Plane 
...
namespace Vazgriz.Plane
{
    public class AIController : MonoBehaviour
    {
        ...
        void Start()
        {
            targetPosition = new Vector3(Random.Range(-3000, 3000), Random.Range(500, 5000), Random.Range(-3000, 3000));
        ...
        Vector3 GetMissileDodgePosition(float dt, Transform missile)
        {
        ...
        public bool dodge, TerrainAvoidance;
        ...
        void FixedUpdate()
        {
            ...
            if (TerrainAvoidance)
            {
                targetPosition = transform.position + transform.forward * 1500 + Vector3.up * 5000;
            }
            else if (targetPos == null)
            {
                if ((transform.position - targetPosition).magnitude < 500)
                {
                    //targetPosition = new Vector3(Random.Range(-30000, 30000), Random.Range(500, 5000), Random.Range(-30000, 30000));
                }
            }
            else if (dodge&&false)
            {
                if (LeftRight == 1)
                    targetPosition = missile.position + missile.right * 1000f + missile.forward * 100;
                else
                    targetPosition = missile.position + missile.right * -1000f + missile.forward * 100;
            }
            else
            ...
            //RaycastHit hit;
            //if (Physics.Raycast(transform.position, Vector3.down, out hit, groundCollisionDistance))
            //{
            ...
            //else
            {
                ...
                */
                //if(dodge)
                //{
                //    targetPosition = GetMissileDodgePosition(dt, missile);
                //    emergency = true;
                //}
                //if (/*incomingMissile == null &&*/dodge != false && (plane.LocalVelocity.z < recoverSpeedMin || isRecoveringSpeed))
                //{
